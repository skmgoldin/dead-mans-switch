...
contract Dead {
    ...
    */
    ...
    /**
    @dev the owner can call this function to signal that they are alive, giving them another
    heartbeatPeriod before they must call the function again or forfeit their assets to the
    beneficiary
    */
    ...
    /**
    @notice make sure to have approved this contract to transfer from your balance before calling
    this. Note that you cannot get these tokens out again unless you are the owner, or if you are
    the beneficiary and the owner has died
    ...
    */
    function depositERC20(address _tokenAddr, uint _amount) public {
        ...
        Erc20Withdraw(_amount, _tokenAddr);
    }

    /**
    @dev if you are the owner, you can call this function any time. If you are a beneficiary,
    you can call it after the owner has died. If you are anybody else, you can't call it.
